...
<body>
        ...
        <div class="container" style="margin-top: auto">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto" style="margin-top: 5px">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active fw-semibold" href="{{ route('admin.peminjaman') }}" style="color: #060355;">Peminjaman</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col">
                <a class="btn text-white" style="background-color: #ED9700;" target="_blank" href="{{ route('admin.cetakDataPeminjaman') }}" style="text-decoration: none; margin-right:30px">Cetak Data</a>
            </div>
            <div class="col"></div>
            <div class="col-2">
                <a class="btn text-light" href="{{ route('admin.tambahPeminjaman') }}" style="background-color: #ED9700; text-decoration: none; margin-left:30px">Tambah Data+</a>
            </div>
        </div>

        <table class="table table-striped table-bordered" style="border: #ED9700; margin-top:20px;">
            ...
            <tbody>
                @foreach ($data as $index => $peminjam)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-outline-success" href="/admin/detailPeminjaman/{{$peminjam->id }}/{{ $peminjam->id_user }}/{{ $peminjam->id_buku}}">Detail</a>
                            <a class="btn btn-outline-secondary" href="/admin/editPeminjaman/{{ $peminjam->id }}">Edit</a>
