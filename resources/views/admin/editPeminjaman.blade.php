        ...
        <div class="row">
            <div class="col d-flex justify-content-center">
                <div class="card mt-4" style="width: 800px">
                    <div class="card-body">
                        <h5 class="card-title text-center" style="color: #ED9700;">Edit Data</h5>
                        <form action="/postEditPeminjaman/{{ $data->id }}" method="POST">
                            @csrf
                            <div class="form-group mt-4">
                                <label class="text-secondary mb-2">Nomor Anggota</label>
                                <input type="text" class="form-control border border-warning form-control" name="idUser" required value="{{ $data->id_user }}">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control border border-warning form-control" name="kodeBuku" required value="{{ $data->id_buku }}">
                                <span class="text-danger">
                                    @error('kodeBuku')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control border border-warning form-control" name="tanggalPeminjaman" required value="{{ $data->tanggal_pinjam }}">
                                <span class="text-danger">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control border border-warning form-control" name="tanggalPengembalian" required value="{{ $data->tanggal_kembali }}">
                                <span class="text-danger">
                            ...
                            <br>
                            <div class="form-group mt-1">
                                <label class="text-secondary">Pilih staus peminjaman</label><br>
                            ...
                            <br>
                            <button type="submit" class="btn text-light mt-5" style="background-color: #ED9700;">Update Data Peminjaman</button>
                        </form>
                    </div>
                </div>
            </div>
