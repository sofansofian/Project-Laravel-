    ...
    <div class="container d-flex justify-content-center align-items-center" style="margin-top: 60px">
        <div class="card" style="width: 35%">
            <div class="card-body p-4">
                <h3 class="card-title text-center fw-semibold" style="color: #ED9700;">Register</h3>
                <form action="{{ route('postRegister') }}" method="POST">
                    @csrf
                    <div class="form-group mt-4">
                        <label class="text-secondary">Nama Anda</label>
                        <input type="text" class="form-control border border-warning form-control-lg" name="name" required value="{{ old('name') }}">
                    ...
                    <div class="form-group mt-1">
                        ...
                        <input type="email" class="form-control border border-warning form-control-lg" name="email" required value="{{ old('email') }}">
                        <span class="text-danger">
                            @error('email')
                            {{ $message }}
                            @enderror
                    ...
                    <div class="form-group mt-1">
                        ...
                        <input type="password" class="form-control border border-warning form-control-lg" name="password">
                        <span class="text-danger">
                            @error('password')
                            {{ $message }}
                            @enderror
                    ...
                    <div class="form-group mt-1">
                        <label class="text-secondary">Konfirmasi Password
                            Anda</label>
                        <input type="password" class="form-control border border-warning form-control-lg" name="password_confirmation" required>
                        <span class="text-danger">
           ...
           <button type="submit" class=" form-control text-light mt5" style="background-color: #ED9700;">Register</button>
                </form>
                <p class="mt-2 text-center">Sudah punya akun? <a href="{{ route('auth.login') }}" style="color : #ED9700; text-decoration: none">Ayo
                        masuk!</a></p>
            </div>
        </div>
</div>
